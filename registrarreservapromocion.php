...
<head>
    ...
    <title>Registrar reserva promoción</title>
</head>
...
<body>
    <div class="container">
        ...
        if (isset($_POST['ci'], $_POST['nombres'], $_POST['apellidopaterno'], $_POST['apellidomaterno'], $_POST['telefono'], $_POST['fechainicio'], $_POST['fechafin'], $_POST['habitacionid'], $_POST['promocionid'])) {
            $ci = $_POST['ci'];
            ...
            try {
                $reservaId = $db->storeReservationWithPromo($ci, $nombres, $apellidoPaterno, $apellidoMaterno, $telefono, $fechaInicio, $fechaFin, $habitacionId, $promocionId);

                $reservation = $db->getReservationsByIdWithPromo($reservaId);
                    ...
                    <div class="reservation-details">
                        ...
                        <ul class="reservation-details__list">
                            ...
                            <li class="reservation-details__list-item">
                                <span>Precio</span>
                                <span>
                                    <?= round((1 - ($reservation['porcentaje_descuento'] / 100)) * $reservation['precio']) . "00" ?>
                                    <span class="strikethrough"><?= $reservation['precio'] ?></span>
                                </span>
                            </li>
                        </ul>
                        <ul class="reservation-details__list">
                        ...
                        <ul class="reservation-details__list">
                            <h3 class="reservation-details__title">Promoción</h3>
                            <li class="reservation-details__list-item">
                                <span>Nombre</span>
                                <span><?= $reservation['promocion'] ?></span>
                            </li>
                            <li class="reservation-details__list-item">
                                <span>Descuento (%)</span>
                                <span><?= $reservation['porcentaje_descuento'] ?></span>
                            </li>
                        </ul>
                    </div>
